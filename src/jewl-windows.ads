...
generic                         -- This is a generic package which must be
   type Command_Type is 
         (<>);    -- instantiated with a list of possible
...
package Jewl.Windows is         -- a window is closed, a button is clicked
   ...
   procedure Play_Sound (
         Sound : in     String );  -- play a sound file
   ...
   function Light (
         Colour : Jewl.Colour_Type ) 
     return Jewl.Colour_Type renames Jewl.Light; 
   function Dark (
         Colour : Jewl.Colour_Type ) 
     return Jewl.Colour_Type renames Jewl.Dark; 
   ...
   function Font (
     ...
     return Jewl.Font_Type renames Jewl.Font; 
   function Name (
         Font : Font_Type ) 
     return String renames Jewl.Name; 
   function Size (
         Font : Font_Type ) 
     return Natural renames Jewl.Size; 
   function Bold (
         Font : Font_Type ) 
     return Boolean renames Jewl.Bold; 
   function Italic (
         Font : Font_Type ) 
     return Boolean renames Jewl.Italic; 
   ...
   function Endpoint (
         ...
         Length : Positive;        
         Angle  : Jewl.Angle_Type  ) 
     return Jewl.Point_Type renames Jewl.Endpoint; 
   function Inside (
         Point : Jewl.Point_Type; 
         From  : Jewl.Point_Type; 
         To    : Jewl.Point_Type  ) 
     return Boolean renames Jewl.Inside; 
   function "+" (
         P1,             
         P2 : Point_Type ) 
     return Point_Type renames Jewl. "+"; 
   function "-" (
         P1,             
         P2 : Point_Type ) 
     return Point_Type renames Jewl. "-"; 
   ...
   function Get_Color (
         Dialog : in     Colour_Dialog_Type ) 
     return Colour_Type renames Get_Colour; 
